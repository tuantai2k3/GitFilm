"""
Django settings for PythFilm project.
...
SECRET_KEY = 'django-insecure-3a8y&bn8%+hxc*ohdcw&c*vukj8$z2n@*-k1@c39sot58e6138'
...
WSGI_APPLICATION = 'PythFilm.wsgi.application'
